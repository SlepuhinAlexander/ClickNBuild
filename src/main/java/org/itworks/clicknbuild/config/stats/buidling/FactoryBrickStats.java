...
public final class FactoryBrickStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setProduction(new ResourcePack[]{
                ...
                new ResourcePack( // 2
                        new ResourceChunk(ResType.BRICK, 120)
                ),
                new ResourcePack( // 3
                        new ResourceChunk(ResType.BRICK, 180)
                ),
                new ResourcePack( // 4
                        new ResourceChunk(ResType.BRICK, 240)
                ),
                new ResourcePack( // 5
                        new ResourceChunk(ResType.BRICK, 300)
                ),
                new ResourcePack( // 6
                        new ResourceChunk(ResType.BRICK, 420)
                ),
                new ResourcePack( // 7
                        new ResourceChunk(ResType.BRICK, 540)
                ),
                new ResourcePack( // 8
                        new ResourceChunk(ResType.BRICK, 660)
                ),
                new ResourcePack( // 9
                        new ResourceChunk(ResType.BRICK, 780)
                ),
                new ResourcePack( // 10
                        new ResourceChunk(ResType.BRICK, 960)
                ),
                new ResourcePack( // 11
                        new ResourceChunk(ResType.BRICK, 1140)
                ),
                new ResourcePack( // 12
                        new ResourceChunk(ResType.BRICK, 1320)
                ),
                new ResourcePack( // 13
                        new ResourceChunk(ResType.BRICK, 1500)
                ),
                new ResourcePack( // 14
                        new ResourceChunk(ResType.BRICK, 1680)
                ),
                new ResourcePack( // 15
                        new ResourceChunk(ResType.BRICK, 1860)
                ),
                new ResourcePack( // 16
                        new ResourceChunk(ResType.BRICK, 2100)
                ),
                new ResourcePack( // 17
                        new ResourceChunk(ResType.BRICK, 2340)
                ),
                new ResourcePack( // 18
                        new ResourceChunk(ResType.BRICK, 2580)
                ),
                new ResourcePack( // 19
                        new ResourceChunk(ResType.BRICK, 2760)
                ),
                new ResourcePack( // 20
        ...
        setJobReward(new ResourcePack[]{
                ...
                new ResourcePack( // 3
                        new ResourceChunk(ResType.BRICK, 90)
                ),
                new ResourcePack( // 4
                        new ResourceChunk(ResType.BRICK, 120)
                ),
                new ResourcePack( // 5
                        new ResourceChunk(ResType.BRICK, 150)
                ),
                new ResourcePack( // 6
                        new ResourceChunk(ResType.BRICK, 210)
                ),
                new ResourcePack( // 7
                        new ResourceChunk(ResType.BRICK, 270)
                ),
                new ResourcePack( // 8
                        new ResourceChunk(ResType.BRICK, 330)
                ),
                new ResourcePack( // 9
                        new ResourceChunk(ResType.BRICK, 390)
                ),
                new ResourcePack( // 10
                        new ResourceChunk(ResType.BRICK, 480)
                ),
                new ResourcePack( // 11
                        new ResourceChunk(ResType.BRICK, 570)
                ),
                new ResourcePack( // 12
                        new ResourceChunk(ResType.BRICK, 660)
                ),
                new ResourcePack( // 13
                        new ResourceChunk(ResType.BRICK, 750)
                ),
                new ResourcePack( // 14
                        new ResourceChunk(ResType.BRICK, 840)
                ),
                new ResourcePack( // 15
                        new ResourceChunk(ResType.BRICK, 930)
                ),
                new ResourcePack( // 16
                        new ResourceChunk(ResType.BRICK, 1050)
                ),
                new ResourcePack( // 17
                        new ResourceChunk(ResType.BRICK, 1170)
                ),
                new ResourcePack( // 18
                        new ResourceChunk(ResType.BRICK, 1290)
                ),
                new ResourcePack( // 19
                        new ResourceChunk(ResType.BRICK, 1380)
                ),
                new ResourcePack( // 20
                        new ResourceChunk(ResType.BRICK, 1500)
                )
