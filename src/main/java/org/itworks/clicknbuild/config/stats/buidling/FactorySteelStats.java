...
public final class FactorySteelStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setProduction(new ResStatPack[]{
                new ResStatPack( // 1
                        new ResStat(ResType.STEEL, 24)
                ),
                new ResStatPack( // 2
                        new ResStat(ResType.STEEL, 48)
                ),
                new ResStatPack( // 3
                        new ResStat(ResType.STEEL, 72)
                ),
                new ResStatPack( // 4
                        new ResStat(ResType.STEEL, 96)
                ),
                new ResStatPack( // 5
                        new ResStat(ResType.STEEL, 120)
                ),
                new ResStatPack( // 6
                        new ResStat(ResType.STEEL, 168)
                ),
                new ResStatPack( // 7
                        new ResStat(ResType.STEEL, 216)
                ),
                new ResStatPack( // 8
                        new ResStat(ResType.STEEL, 264)
                ),
                new ResStatPack( // 9
                        new ResStat(ResType.STEEL, 312)
                ),
                new ResStatPack( // 10
                        new ResStat(ResType.STEEL, 384)
                ),
                new ResStatPack( // 11
                        new ResStat(ResType.STEEL, 456)
                ),
                new ResStatPack( // 12
                        new ResStat(ResType.STEEL, 528)
                ),
                new ResStatPack( // 13
                        new ResStat(ResType.STEEL, 600)
                ),
                new ResStatPack( // 14
                        new ResStat(ResType.STEEL, 672)
                ),
                new ResStatPack( // 15
                        new ResStat(ResType.STEEL, 744)
                ),
                new ResStatPack( // 16
                        new ResStat(ResType.STEEL, 840)
                ),
                new ResStatPack( // 17
                        new ResStat(ResType.STEEL, 936)
                ),
                new ResStatPack( // 18
                        new ResStat(ResType.STEEL, 1032)
                ),
                new ResStatPack( // 19
                        new ResStat(ResType.STEEL, 1104)
                ),
                new ResStatPack( // 20
        ...
        setJobReward(new ResStatPack[]{
                ...
                new ResStatPack( // 7
                        new ResStat(ResType.STEEL, 108)
                ),
                new ResStatPack( // 8
                        new ResStat(ResType.STEEL, 132)
                ),
                new ResStatPack( // 9
                        new ResStat(ResType.STEEL, 156)
                ),
                new ResStatPack( // 10
                        new ResStat(ResType.STEEL, 192)
                ),
                new ResStatPack( // 11
                        new ResStat(ResType.STEEL, 228)
                ),
                new ResStatPack( // 12
                        new ResStat(ResType.STEEL, 264)
                ),
                new ResStatPack( // 13
                        new ResStat(ResType.STEEL, 300)
                ),
                new ResStatPack( // 14
                        new ResStat(ResType.STEEL, 336)
                ),
                new ResStatPack( // 15
                        new ResStat(ResType.STEEL, 372)
                ),
                new ResStatPack( // 16
                        new ResStat(ResType.STEEL, 420)
                ),
                new ResStatPack( // 17
                        new ResStat(ResType.STEEL, 468)
                ),
                new ResStatPack( // 18
                        new ResStat(ResType.STEEL, 516)
                ),
                new ResStatPack( // 19
                        new ResStat(ResType.STEEL, 552)
                ),
                new ResStatPack( // 20
                        new ResStat(ResType.STEEL, 600)
                )
