...
public final class PoliceStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setDemand(new ResourcePack[]{
                ...
                new ResourcePack( // 13
                        new ResourceChunk(ResourceType.UPKEEP, 4800),
        ...
        setStore(new ResourcePack[]{
                new ResourcePack( // 1
                        new ResourceChunk(ResourceType.OBEDIENCE, 2000)
                ),
                new ResourcePack( // 2
                        new ResourceChunk(ResourceType.OBEDIENCE, 4000)
                ),
                new ResourcePack( // 3
                        new ResourceChunk(ResourceType.OBEDIENCE, 6000)
                ),
                new ResourcePack( // 4
                        new ResourceChunk(ResourceType.OBEDIENCE, 8000)
                ),
                new ResourcePack( // 5
                        new ResourceChunk(ResourceType.OBEDIENCE, 10000)
                ),
                new ResourcePack( // 6
                        new ResourceChunk(ResourceType.OBEDIENCE, 14000)
                ),
                new ResourcePack( // 7
                        new ResourceChunk(ResourceType.OBEDIENCE, 18000)
                ),
                new ResourcePack( // 8
                        new ResourceChunk(ResourceType.OBEDIENCE, 22000)
                ),
                new ResourcePack( // 9
                        new ResourceChunk(ResourceType.OBEDIENCE, 26000)
                ),
                new ResourcePack( // 10
                        new ResourceChunk(ResourceType.OBEDIENCE, 30000)
                ),
                new ResourcePack( // 11
                        new ResourceChunk(ResourceType.OBEDIENCE, 36000)
                ),
                new ResourcePack( // 12
                        new ResourceChunk(ResourceType.OBEDIENCE, 42000)
                ),
                new ResourcePack( // 13
                        new ResourceChunk(ResourceType.OBEDIENCE, 48000)
                ),
                new ResourcePack( // 14
                        new ResourceChunk(ResourceType.OBEDIENCE, 54000)
                ),
                new ResourcePack( // 15
                        new ResourceChunk(ResourceType.OBEDIENCE, 60000)
                ),
                new ResourcePack( // 16
                        new ResourceChunk(ResourceType.OBEDIENCE, 68000)
                ),
                new ResourcePack( // 17
                        new ResourceChunk(ResourceType.OBEDIENCE, 76000)
                ),
                new ResourcePack( // 18
                        new ResourceChunk(ResourceType.OBEDIENCE, 84000)
                ),
                new ResourcePack( // 19
                        new ResourceChunk(ResourceType.OBEDIENCE, 92000)
                ),
                new ResourcePack( // 20
                        new ResourceChunk(ResourceType.OBEDIENCE, 100000)
                )
        });
    }
}
