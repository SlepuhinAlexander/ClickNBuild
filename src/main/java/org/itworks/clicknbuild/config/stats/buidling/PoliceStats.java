...
public final class PoliceStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setDemand(new ResStatPack[]{
                ...
                new ResStatPack( // 13
                        new ResStat(ResType.UPKEEP, 4800),
        ...
        setCapacity(new ResStatPack[]{
                ...
                new ResStatPack( // 2
                        new ResStat(ResType.OBEDIENCE, 4000)
                ),
                new ResStatPack( // 3
                        new ResStat(ResType.OBEDIENCE, 6000)
                ),
                new ResStatPack( // 4
                        new ResStat(ResType.OBEDIENCE, 8000)
                ),
                new ResStatPack( // 5
                        new ResStat(ResType.OBEDIENCE, 10000)
                ),
                new ResStatPack( // 6
                        new ResStat(ResType.OBEDIENCE, 14000)
                ),
                new ResStatPack( // 7
                        new ResStat(ResType.OBEDIENCE, 18000)
                ),
                new ResStatPack( // 8
                        new ResStat(ResType.OBEDIENCE, 22000)
                ),
                new ResStatPack( // 9
                        new ResStat(ResType.OBEDIENCE, 26000)
                ),
                new ResStatPack( // 10
                        new ResStat(ResType.OBEDIENCE, 30000)
                ),
                new ResStatPack( // 11
                        new ResStat(ResType.OBEDIENCE, 36000)
                ),
                new ResStatPack( // 12
                        new ResStat(ResType.OBEDIENCE, 42000)
                ),
                new ResStatPack( // 13
                        new ResStat(ResType.OBEDIENCE, 48000)
                ),
                new ResStatPack( // 14
                        new ResStat(ResType.OBEDIENCE, 54000)
                ),
                new ResStatPack( // 15
                        new ResStat(ResType.OBEDIENCE, 60000)
                ),
                new ResStatPack( // 16
                        new ResStat(ResType.OBEDIENCE, 68000)
                ),
                new ResStatPack( // 17
                        new ResStat(ResType.OBEDIENCE, 76000)
                ),
                new ResStatPack( // 18
                        new ResStat(ResType.OBEDIENCE, 84000)
                ),
                new ResStatPack( // 19
                        new ResStat(ResType.OBEDIENCE, 92000)
                ),
                new ResStatPack( // 20
                        new ResStat(ResType.OBEDIENCE, 100000)
                )
        });
    }
}
