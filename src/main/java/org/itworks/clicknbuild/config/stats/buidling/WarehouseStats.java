...
public final class WarehouseStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setStore(new ResourcePack[]{
                new ResourcePack( // 1
                        new ResourceChunk(ResType.STEEL, 400),
                        new ResourceChunk(ResType.CONCRETE, 400),
                        new ResourceChunk(ResType.BRICK, 400),
                        new ResourceChunk(ResType.WOOD, 400),
                        new ResourceChunk(ResType.GLASS, 400)
                ),
                new ResourcePack( // 2
                        new ResourceChunk(ResType.STEEL, 800),
                        new ResourceChunk(ResType.CONCRETE, 800),
                        new ResourceChunk(ResType.BRICK, 800),
                        new ResourceChunk(ResType.WOOD, 800),
                        new ResourceChunk(ResType.GLASS, 800)
                ),
                new ResourcePack( // 3
                        new ResourceChunk(ResType.STEEL, 1200),
                        new ResourceChunk(ResType.CONCRETE, 1200),
                        new ResourceChunk(ResType.BRICK, 1200),
                        new ResourceChunk(ResType.WOOD, 1200),
                        new ResourceChunk(ResType.GLASS, 1200)
                ),
                new ResourcePack( // 4
                        new ResourceChunk(ResType.STEEL, 1600),
                        new ResourceChunk(ResType.CONCRETE, 1600),
                        new ResourceChunk(ResType.BRICK, 1600),
                        new ResourceChunk(ResType.WOOD, 1600),
                        new ResourceChunk(ResType.GLASS, 1600)
                ),
                new ResourcePack( // 5
                        new ResourceChunk(ResType.STEEL, 2000),
                        new ResourceChunk(ResType.CONCRETE, 2000),
                        new ResourceChunk(ResType.BRICK, 2000),
                        new ResourceChunk(ResType.WOOD, 2000),
                        new ResourceChunk(ResType.GLASS, 2000)
                ),
                new ResourcePack( // 6
                        new ResourceChunk(ResType.STEEL, 2800),
                        new ResourceChunk(ResType.CONCRETE, 2800),
                        new ResourceChunk(ResType.BRICK, 2800),
                        new ResourceChunk(ResType.WOOD, 2800),
                        new ResourceChunk(ResType.GLASS, 2800)
                ),
                new ResourcePack( // 7
                        new ResourceChunk(ResType.STEEL, 3600),
                        new ResourceChunk(ResType.CONCRETE, 3600),
                        new ResourceChunk(ResType.BRICK, 3600),
                        new ResourceChunk(ResType.WOOD, 3600),
                        new ResourceChunk(ResType.GLASS, 3600)
                ),
                new ResourcePack( // 8
                        new ResourceChunk(ResType.STEEL, 4400),
                        new ResourceChunk(ResType.CONCRETE, 4400),
                        new ResourceChunk(ResType.BRICK, 4400),
                        new ResourceChunk(ResType.WOOD, 4400),
                        new ResourceChunk(ResType.GLASS, 4400)
                ),
                new ResourcePack( // 9
                        new ResourceChunk(ResType.STEEL, 5200),
                        new ResourceChunk(ResType.CONCRETE, 5200),
                        new ResourceChunk(ResType.BRICK, 5200),
                        new ResourceChunk(ResType.WOOD, 5200),
                        new ResourceChunk(ResType.GLASS, 5200)
                ),
                new ResourcePack( // 10
                        new ResourceChunk(ResType.STEEL, 6000),
                        new ResourceChunk(ResType.CONCRETE, 6000),
                        new ResourceChunk(ResType.BRICK, 6000),
                        new ResourceChunk(ResType.WOOD, 6000),
                        new ResourceChunk(ResType.GLASS, 6000)
                ),
                new ResourcePack( // 11
                        new ResourceChunk(ResType.STEEL, 7200),
                        new ResourceChunk(ResType.CONCRETE, 7200),
                        new ResourceChunk(ResType.BRICK, 7200),
                        new ResourceChunk(ResType.WOOD, 7200),
                        new ResourceChunk(ResType.GLASS, 7200)
                ),
                new ResourcePack( // 12
                        new ResourceChunk(ResType.STEEL, 8400),
                        new ResourceChunk(ResType.CONCRETE, 8400),
                        new ResourceChunk(ResType.BRICK, 8400),
                        new ResourceChunk(ResType.WOOD, 8400),
                        new ResourceChunk(ResType.GLASS, 8400)
                ),
                new ResourcePack( // 13
                        new ResourceChunk(ResType.STEEL, 9600),
                        new ResourceChunk(ResType.CONCRETE, 9600),
                        new ResourceChunk(ResType.BRICK, 9600),
                        new ResourceChunk(ResType.WOOD, 9600),
                        new ResourceChunk(ResType.GLASS, 9600)
                ),
                new ResourcePack( // 14
                        new ResourceChunk(ResType.STEEL, 10800),
                        new ResourceChunk(ResType.CONCRETE, 10800),
                        new ResourceChunk(ResType.BRICK, 10800),
                        new ResourceChunk(ResType.WOOD, 10800),
                        new ResourceChunk(ResType.GLASS, 10800)
                ),
                new ResourcePack( // 15
                        new ResourceChunk(ResType.STEEL, 12000),
                        new ResourceChunk(ResType.CONCRETE, 12000),
                        new ResourceChunk(ResType.BRICK, 12000),
                        new ResourceChunk(ResType.WOOD, 12000),
                        new ResourceChunk(ResType.GLASS, 12000)
                ),
                new ResourcePack( // 16
                        new ResourceChunk(ResType.STEEL, 13600),
                        new ResourceChunk(ResType.CONCRETE, 13600),
                        new ResourceChunk(ResType.BRICK, 13600),
                        new ResourceChunk(ResType.WOOD, 13600),
                        new ResourceChunk(ResType.GLASS, 13600)
                ),
                new ResourcePack( // 17
                        new ResourceChunk(ResType.STEEL, 15200),
                        new ResourceChunk(ResType.CONCRETE, 15200),
                        new ResourceChunk(ResType.BRICK, 15200),
                        new ResourceChunk(ResType.WOOD, 15200),
                        new ResourceChunk(ResType.GLASS, 15200)
                ),
                new ResourcePack( // 18
                        new ResourceChunk(ResType.STEEL, 16800),
                        new ResourceChunk(ResType.CONCRETE, 16800),
                        new ResourceChunk(ResType.BRICK, 16800),
                        new ResourceChunk(ResType.WOOD, 16800),
                        new ResourceChunk(ResType.GLASS, 16800)
                ),
                new ResourcePack( // 19
                        new ResourceChunk(ResType.STEEL, 18400),
                        new ResourceChunk(ResType.CONCRETE, 18400),
                        new ResourceChunk(ResType.BRICK, 18400),
                        new ResourceChunk(ResType.WOOD, 18400),
                        new ResourceChunk(ResType.GLASS, 18400)
                ),
                new ResourcePack( // 20
                        new ResourceChunk(ResType.STEEL, 20000),
                        new ResourceChunk(ResType.CONCRETE, 20000),
                        new ResourceChunk(ResType.BRICK, 20000),
                        new ResourceChunk(ResType.WOOD, 20000),
                        new ResourceChunk(ResType.GLASS, 20000)
                )
        });
    }
}
