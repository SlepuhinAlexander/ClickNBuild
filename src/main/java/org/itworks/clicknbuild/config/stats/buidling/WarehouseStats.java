    ...
    protected void initValues() {
        ...
        setBuildCost(new ResStatPack[]{
                ...
                new ResStatPack( // 4
                        ...
                        new ResStat(ResType.STEEL, 1060),
                ...
                new ResStatPack( // 5
                        ...
                        new ResStat(ResType.STEEL, 1610),
                ...
                new ResStatPack( // 6
                        ...
                        new ResStat(ResType.STEEL, 2408),
                ...
                new ResStatPack( // 7
                        ...
                        new ResStat(ResType.STEEL, 3470),
                ...
                new ResStatPack( // 8
                        ...
                        new ResStat(ResType.STEEL, 4812),
                ...
                new ResStatPack( // 9
                        ...
                        new ResStat(ResType.STEEL, 6450),
                ...
                new ResStatPack( // 11
                        ...
                        new ResStat(ResType.STEEL, 10848),
                ...
                new ResStatPack( // 12
                        ...
                        new ResStat(ResType.STEEL, 13830),
                ...
                new ResStatPack( // 13
                        ...
                        new ResStat(ResType.STEEL, 17382),
                ...
                new ResStatPack( // 14
                        ...
                        new ResStat(ResType.STEEL, 21540),
                ...
                new ResStatPack( // 15
                        ...
                        new ResStat(ResType.STEEL, 26340),
                ...
                new ResStatPack( // 16
                        ...
                        new ResStat(ResType.STEEL, 32052),
                ...
                new ResStatPack( // 17
                        ...
                        new ResStat(ResType.STEEL, 38740),
                ...
                new ResStatPack( // 18
                        ...
                        new ResStat(ResType.STEEL, 46468),
                ...
                new ResStatPack( // 19
                        ...
                        new ResStat(ResType.STEEL, 55300),
                ...
                new ResStatPack( // 20
                        ...
                        new ResStat(ResType.STEEL, 65300),
        ...
        setStore(new ResStatPack[]{
                new ResStatPack( // 1
                        new ResStat(ResType.STEEL, 400),
                        new ResStat(ResType.CONCRETE, 400),
                        new ResStat(ResType.BRICK, 400),
                        new ResStat(ResType.WOOD, 400),
                        new ResStat(ResType.GLASS, 400)
                ),
                new ResStatPack( // 2
                        new ResStat(ResType.STEEL, 800),
                        new ResStat(ResType.CONCRETE, 800),
                        new ResStat(ResType.BRICK, 800),
                        new ResStat(ResType.WOOD, 800),
                        new ResStat(ResType.GLASS, 800)
                ),
                new ResStatPack( // 3
                        new ResStat(ResType.STEEL, 1200),
                        new ResStat(ResType.CONCRETE, 1200),
                        new ResStat(ResType.BRICK, 1200),
                        new ResStat(ResType.WOOD, 1200),
                        new ResStat(ResType.GLASS, 1200)
                ),
                new ResStatPack( // 4
                        new ResStat(ResType.STEEL, 1600),
                        new ResStat(ResType.CONCRETE, 1600),
                        new ResStat(ResType.BRICK, 1600),
                        new ResStat(ResType.WOOD, 1600),
                        new ResStat(ResType.GLASS, 1600)
                ),
                new ResStatPack( // 5
                        new ResStat(ResType.STEEL, 2000),
                        new ResStat(ResType.CONCRETE, 2000),
                        new ResStat(ResType.BRICK, 2000),
                        new ResStat(ResType.WOOD, 2000),
                        new ResStat(ResType.GLASS, 2000)
                ),
                new ResStatPack( // 6
                        new ResStat(ResType.STEEL, 2800),
                        new ResStat(ResType.CONCRETE, 2800),
                        new ResStat(ResType.BRICK, 2800),
                        new ResStat(ResType.WOOD, 2800),
                        new ResStat(ResType.GLASS, 2800)
                ),
                new ResStatPack( // 7
                        new ResStat(ResType.STEEL, 3600),
                        new ResStat(ResType.CONCRETE, 3600),
                        new ResStat(ResType.BRICK, 3600),
                        new ResStat(ResType.WOOD, 3600),
                        new ResStat(ResType.GLASS, 3600)
                ),
                new ResStatPack( // 8
                        new ResStat(ResType.STEEL, 4400),
                        new ResStat(ResType.CONCRETE, 4400),
                        new ResStat(ResType.BRICK, 4400),
                        new ResStat(ResType.WOOD, 4400),
                        new ResStat(ResType.GLASS, 4400)
                ),
                new ResStatPack( // 9
                        new ResStat(ResType.STEEL, 5200),
                        new ResStat(ResType.CONCRETE, 5200),
                        new ResStat(ResType.BRICK, 5200),
                        new ResStat(ResType.WOOD, 5200),
                        new ResStat(ResType.GLASS, 5200)
                ),
                new ResStatPack( // 10
                        new ResStat(ResType.STEEL, 6000),
                        new ResStat(ResType.CONCRETE, 6000),
                        new ResStat(ResType.BRICK, 6000),
                        new ResStat(ResType.WOOD, 6000),
                        new ResStat(ResType.GLASS, 6000)
                ),
                new ResStatPack( // 11
                        new ResStat(ResType.STEEL, 7200),
                        new ResStat(ResType.CONCRETE, 7200),
                        new ResStat(ResType.BRICK, 7200),
                        new ResStat(ResType.WOOD, 7200),
                        new ResStat(ResType.GLASS, 7200)
                ),
                new ResStatPack( // 12
                        new ResStat(ResType.STEEL, 8400),
                        new ResStat(ResType.CONCRETE, 8400),
                        new ResStat(ResType.BRICK, 8400),
                        new ResStat(ResType.WOOD, 8400),
                        new ResStat(ResType.GLASS, 8400)
                ),
                new ResStatPack( // 13
                        new ResStat(ResType.STEEL, 9600),
                        new ResStat(ResType.CONCRETE, 9600),
                        new ResStat(ResType.BRICK, 9600),
                        new ResStat(ResType.WOOD, 9600),
                        new ResStat(ResType.GLASS, 9600)
                ),
                new ResStatPack( // 14
                        new ResStat(ResType.STEEL, 10800),
                        new ResStat(ResType.CONCRETE, 10800),
                        new ResStat(ResType.BRICK, 10800),
                        new ResStat(ResType.WOOD, 10800),
                        new ResStat(ResType.GLASS, 10800)
                ),
                new ResStatPack( // 15
                        new ResStat(ResType.STEEL, 12000),
                        new ResStat(ResType.CONCRETE, 12000),
                        new ResStat(ResType.BRICK, 12000),
                        new ResStat(ResType.WOOD, 12000),
                        new ResStat(ResType.GLASS, 12000)
                ),
                new ResStatPack( // 16
                        new ResStat(ResType.STEEL, 13600),
                        new ResStat(ResType.CONCRETE, 13600),
                        new ResStat(ResType.BRICK, 13600),
                        new ResStat(ResType.WOOD, 13600),
                        new ResStat(ResType.GLASS, 13600)
                ),
                new ResStatPack( // 17
                        new ResStat(ResType.STEEL, 15200),
                        new ResStat(ResType.CONCRETE, 15200),
                        new ResStat(ResType.BRICK, 15200),
                        new ResStat(ResType.WOOD, 15200),
                        new ResStat(ResType.GLASS, 15200)
                ),
                new ResStatPack( // 18
                        new ResStat(ResType.STEEL, 16800),
                        new ResStat(ResType.CONCRETE, 16800),
                        new ResStat(ResType.BRICK, 16800),
                        new ResStat(ResType.WOOD, 16800),
                        new ResStat(ResType.GLASS, 16800)
                ),
                new ResStatPack( // 19
                        new ResStat(ResType.STEEL, 18400),
                        new ResStat(ResType.CONCRETE, 18400),
                        new ResStat(ResType.BRICK, 18400),
                        new ResStat(ResType.WOOD, 18400),
                        new ResStat(ResType.GLASS, 18400)
                ),
                new ResStatPack( // 20
                        new ResStat(ResType.STEEL, 20000),
                        new ResStat(ResType.CONCRETE, 20000),
                        new ResStat(ResType.BRICK, 20000),
                        new ResStat(ResType.WOOD, 20000),
                        new ResStat(ResType.GLASS, 20000)
                )
        });
    }
}
