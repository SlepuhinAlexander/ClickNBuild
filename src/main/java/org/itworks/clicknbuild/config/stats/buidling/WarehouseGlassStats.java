...
public final class WarehouseGlassStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setStore(new ResourcePack[]{
                ...
                new ResourcePack( // 2
                        new ResourceChunk(ResType.GLASS, 4000)
                ),
                new ResourcePack( // 3
                        new ResourceChunk(ResType.GLASS, 6000)
                ),
                new ResourcePack( // 4
                        new ResourceChunk(ResType.GLASS, 8000)
                ),
                new ResourcePack( // 5
                        new ResourceChunk(ResType.GLASS, 10000)
                ),
                new ResourcePack( // 6
                        new ResourceChunk(ResType.GLASS, 14000)
                ),
                new ResourcePack( // 7
                        new ResourceChunk(ResType.GLASS, 18000)
                ),
                new ResourcePack( // 8
                        new ResourceChunk(ResType.GLASS, 22000)
                ),
                new ResourcePack( // 9
                        new ResourceChunk(ResType.GLASS, 26000)
                ),
                new ResourcePack( // 10
                        new ResourceChunk(ResType.GLASS, 30000)
                ),
                new ResourcePack( // 11
                        new ResourceChunk(ResType.GLASS, 36000)
                ),
                new ResourcePack( // 12
                        new ResourceChunk(ResType.GLASS, 42000)
                ),
                new ResourcePack( // 13
                        new ResourceChunk(ResType.GLASS, 48000)
                ),
                new ResourcePack( // 14
                        new ResourceChunk(ResType.GLASS, 54000)
                ),
                new ResourcePack( // 15
                        new ResourceChunk(ResType.GLASS, 60000)
                ),
                new ResourcePack( // 16
                        new ResourceChunk(ResType.GLASS, 68000)
                ),
                new ResourcePack( // 17
                        new ResourceChunk(ResType.GLASS, 76000)
                ),
                new ResourcePack( // 18
                        new ResourceChunk(ResType.GLASS, 84000)
                ),
                new ResourcePack( // 19
                        new ResourceChunk(ResType.GLASS, 92000)
                ),
                new ResourcePack( // 20
                        new ResourceChunk(ResType.GLASS, 100000)
                )
        });
    }
}
