...
public final class WarehouseGlassStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setStore(new ResPack[]{
                ...
                new ResPack( // 2
                        new ResChunk(ResType.GLASS, 4000)
                ),
                new ResPack( // 3
                        new ResChunk(ResType.GLASS, 6000)
                ),
                new ResPack( // 4
                        new ResChunk(ResType.GLASS, 8000)
                ),
                new ResPack( // 5
                        new ResChunk(ResType.GLASS, 10000)
                ),
                new ResPack( // 6
                        new ResChunk(ResType.GLASS, 14000)
                ),
                new ResPack( // 7
                        new ResChunk(ResType.GLASS, 18000)
                ),
                new ResPack( // 8
                        new ResChunk(ResType.GLASS, 22000)
                ),
                new ResPack( // 9
                        new ResChunk(ResType.GLASS, 26000)
                ),
                new ResPack( // 10
                        new ResChunk(ResType.GLASS, 30000)
                ),
                new ResPack( // 11
                        new ResChunk(ResType.GLASS, 36000)
                ),
                new ResPack( // 12
                        new ResChunk(ResType.GLASS, 42000)
                ),
                new ResPack( // 13
                        new ResChunk(ResType.GLASS, 48000)
                ),
                new ResPack( // 14
                        new ResChunk(ResType.GLASS, 54000)
                ),
                new ResPack( // 15
                        new ResChunk(ResType.GLASS, 60000)
                ),
                new ResPack( // 16
                        new ResChunk(ResType.GLASS, 68000)
                ),
                new ResPack( // 17
                        new ResChunk(ResType.GLASS, 76000)
                ),
                new ResPack( // 18
                        new ResChunk(ResType.GLASS, 84000)
                ),
                new ResPack( // 19
                        new ResChunk(ResType.GLASS, 92000)
                ),
                new ResPack( // 20
                        new ResChunk(ResType.GLASS, 100000)
                )
        });
    }
}
