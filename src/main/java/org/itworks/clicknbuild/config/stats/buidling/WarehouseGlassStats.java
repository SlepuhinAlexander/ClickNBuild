...
public final class WarehouseGlassStats extends BuildingStats {
    private static volatile WarehouseGlassStats inst;

    private WarehouseGlassStats() {
    }

    public static WarehouseGlassStats inst() {
        WarehouseGlassStats local = inst;
        if (local == null) {
            synchronized (WarehouseGlassStats.class) {
                local = inst;
                if (local == null) {
                    inst = local = new WarehouseGlassStats();
                    local.initArrays();
                    local.initValues();
                }
            }
    ...
    protected void initValues() {
        ...
        setStore(new ResStatPack[]{
                ...
                new ResStatPack( // 2
                        new ResStat(ResType.GLASS, 4000)
                ),
                new ResStatPack( // 3
                        new ResStat(ResType.GLASS, 6000)
                ),
                new ResStatPack( // 4
                        new ResStat(ResType.GLASS, 8000)
                ),
                new ResStatPack( // 5
                        new ResStat(ResType.GLASS, 10000)
                ),
                new ResStatPack( // 6
                        new ResStat(ResType.GLASS, 14000)
                ),
                new ResStatPack( // 7
                        new ResStat(ResType.GLASS, 18000)
                ),
                new ResStatPack( // 8
                        new ResStat(ResType.GLASS, 22000)
                ),
                new ResStatPack( // 9
                        new ResStat(ResType.GLASS, 26000)
                ),
                new ResStatPack( // 10
                        new ResStat(ResType.GLASS, 30000)
                ),
                new ResStatPack( // 11
                        new ResStat(ResType.GLASS, 36000)
                ),
                new ResStatPack( // 12
                        new ResStat(ResType.GLASS, 42000)
                ),
                new ResStatPack( // 13
                        new ResStat(ResType.GLASS, 48000)
                ),
                new ResStatPack( // 14
                        new ResStat(ResType.GLASS, 54000)
                ),
                new ResStatPack( // 15
                        new ResStat(ResType.GLASS, 60000)
                ),
                new ResStatPack( // 16
                        new ResStat(ResType.GLASS, 68000)
                ),
                new ResStatPack( // 17
                        new ResStat(ResType.GLASS, 76000)
                ),
                new ResStatPack( // 18
                        new ResStat(ResType.GLASS, 84000)
                ),
                new ResStatPack( // 19
                        new ResStat(ResType.GLASS, 92000)
                ),
                new ResStatPack( // 20
                        new ResStat(ResType.GLASS, 100000)
                )
        });
    }
}
