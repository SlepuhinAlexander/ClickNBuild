...
public final class FactoryGlassStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setProduction(new ResStatPack[]{
                new ResStatPack( // 1
                        new ResStat(ResType.GLASS, 40)
                ),
                new ResStatPack( // 2
                        new ResStat(ResType.GLASS, 80)
                ),
                new ResStatPack( // 3
                        new ResStat(ResType.GLASS, 120)
                ),
                new ResStatPack( // 4
                        new ResStat(ResType.GLASS, 160)
                ),
                new ResStatPack( // 5
                        new ResStat(ResType.GLASS, 200)
                ),
                new ResStatPack( // 6
                        new ResStat(ResType.GLASS, 280)
                ),
                new ResStatPack( // 7
                        new ResStat(ResType.GLASS, 360)
                ),
                new ResStatPack( // 8
                        new ResStat(ResType.GLASS, 440)
                ),
                new ResStatPack( // 9
                        new ResStat(ResType.GLASS, 520)
                ),
                new ResStatPack( // 10
                        new ResStat(ResType.GLASS, 600)
                ),
                new ResStatPack( // 11
                        new ResStat(ResType.GLASS, 720)
                ),
                new ResStatPack( // 12
                        new ResStat(ResType.GLASS, 840)
                ),
                new ResStatPack( // 13
                        new ResStat(ResType.GLASS, 960)
                ),
                new ResStatPack( // 14
                        new ResStat(ResType.GLASS, 1080)
                ),
                new ResStatPack( // 15
                        new ResStat(ResType.GLASS, 1200)
                ),
                new ResStatPack( // 16
                        new ResStat(ResType.GLASS, 1360)
                ),
                new ResStatPack( // 17
                        new ResStat(ResType.GLASS, 1520)
                ),
                new ResStatPack( // 18
                        new ResStat(ResType.GLASS, 1680)
                ),
                new ResStatPack( // 19
                        new ResStat(ResType.GLASS, 1840)
                ),
                new ResStatPack( // 20
        ...
        setJobReward(new ResStatPack[]{
                ...
                new ResStatPack( // 6
                        new ResStat(ResType.GLASS, 140)
                ),
                new ResStatPack( // 7
                        new ResStat(ResType.GLASS, 180)
                ),
                new ResStatPack( // 8
                        new ResStat(ResType.GLASS, 220)
                ),
                new ResStatPack( // 9
                        new ResStat(ResType.GLASS, 260)
                ),
                new ResStatPack( // 10
                        new ResStat(ResType.GLASS, 300)
                ),
                new ResStatPack( // 11
                        new ResStat(ResType.GLASS, 360)
                ),
                new ResStatPack( // 12
                        new ResStat(ResType.GLASS, 420)
                ),
                new ResStatPack( // 13
                        new ResStat(ResType.GLASS, 480)
                ),
                new ResStatPack( // 14
                        new ResStat(ResType.GLASS, 540)
                ),
                new ResStatPack( // 15
                        new ResStat(ResType.GLASS, 600)
                ),
                new ResStatPack( // 16
                        new ResStat(ResType.GLASS, 680)
                ),
                new ResStatPack( // 17
                        new ResStat(ResType.GLASS, 760)
                ),
                new ResStatPack( // 18
                        new ResStat(ResType.GLASS, 840)
                ),
                new ResStatPack( // 19
                        new ResStat(ResType.GLASS, 920)
                ),
                new ResStatPack( // 20
                        new ResStat(ResType.GLASS, 1000)
                )
        });
