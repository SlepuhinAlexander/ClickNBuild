...
public final class FactoryGlassStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setProduction(new ResPack[]{
                new ResPack( // 1
                        new ResChunk(ResType.GLASS, 40)
                ),
                new ResPack( // 2
                        new ResChunk(ResType.GLASS, 80)
                ),
                new ResPack( // 3
                        new ResChunk(ResType.GLASS, 120)
                ),
                new ResPack( // 4
                        new ResChunk(ResType.GLASS, 160)
                ),
                new ResPack( // 5
                        new ResChunk(ResType.GLASS, 200)
                ),
                new ResPack( // 6
                        new ResChunk(ResType.GLASS, 280)
                ),
                new ResPack( // 7
                        new ResChunk(ResType.GLASS, 360)
                ),
                new ResPack( // 8
                        new ResChunk(ResType.GLASS, 440)
                ),
                new ResPack( // 9
                        new ResChunk(ResType.GLASS, 520)
                ),
                new ResPack( // 10
                        new ResChunk(ResType.GLASS, 600)
                ),
                new ResPack( // 11
                        new ResChunk(ResType.GLASS, 720)
                ),
                new ResPack( // 12
                        new ResChunk(ResType.GLASS, 840)
                ),
                new ResPack( // 13
                        new ResChunk(ResType.GLASS, 960)
                ),
                new ResPack( // 14
                        new ResChunk(ResType.GLASS, 1080)
                ),
                new ResPack( // 15
                        new ResChunk(ResType.GLASS, 1200)
                ),
                new ResPack( // 16
                        new ResChunk(ResType.GLASS, 1360)
                ),
                new ResPack( // 17
                        new ResChunk(ResType.GLASS, 1520)
                ),
                new ResPack( // 18
                        new ResChunk(ResType.GLASS, 1680)
                ),
                new ResPack( // 19
                        new ResChunk(ResType.GLASS, 1840)
                ),
                new ResPack( // 20
        ...
        setJobReward(new ResPack[]{
                ...
                new ResPack( // 6
                        new ResChunk(ResType.GLASS, 140)
                ),
                new ResPack( // 7
                        new ResChunk(ResType.GLASS, 180)
                ),
                new ResPack( // 8
                        new ResChunk(ResType.GLASS, 220)
                ),
                new ResPack( // 9
                        new ResChunk(ResType.GLASS, 260)
                ),
                new ResPack( // 10
                        new ResChunk(ResType.GLASS, 300)
                ),
                new ResPack( // 11
                        new ResChunk(ResType.GLASS, 360)
                ),
                new ResPack( // 12
                        new ResChunk(ResType.GLASS, 420)
                ),
                new ResPack( // 13
                        new ResChunk(ResType.GLASS, 480)
                ),
                new ResPack( // 14
                        new ResChunk(ResType.GLASS, 540)
                ),
                new ResPack( // 15
                        new ResChunk(ResType.GLASS, 600)
                ),
                new ResPack( // 16
                        new ResChunk(ResType.GLASS, 680)
                ),
                new ResPack( // 17
                        new ResChunk(ResType.GLASS, 760)
                ),
                new ResPack( // 18
                        new ResChunk(ResType.GLASS, 840)
                ),
                new ResPack( // 19
                        new ResChunk(ResType.GLASS, 920)
                ),
                new ResPack( // 20
                        new ResChunk(ResType.GLASS, 1000)
                )
        });
