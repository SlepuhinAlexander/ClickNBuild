...
public final class WarehouseWoodStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setStore(new ResPack[]{
                ...
                new ResPack( // 3
                        new ResChunk(ResType.WOOD, 3000)
                ),
                new ResPack( // 4
                        new ResChunk(ResType.WOOD, 4000)
                ),
                new ResPack( // 5
                        new ResChunk(ResType.WOOD, 5000)
                ),
                new ResPack( // 6
                        new ResChunk(ResType.WOOD, 7000)
                ),
                new ResPack( // 7
                        new ResChunk(ResType.WOOD, 9000)
                ),
                new ResPack( // 8
                        new ResChunk(ResType.WOOD, 11000)
                ),
                new ResPack( // 9
                        new ResChunk(ResType.WOOD, 13000)
                ),
                new ResPack( // 10
                        new ResChunk(ResType.WOOD, 15000)
                ),
                new ResPack( // 11
                        new ResChunk(ResType.WOOD, 18000)
                ),
                new ResPack( // 12
                        new ResChunk(ResType.WOOD, 21000)
                ),
                new ResPack( // 13
                        new ResChunk(ResType.WOOD, 24000)
                ),
                new ResPack( // 14
                        new ResChunk(ResType.WOOD, 27000)
                ),
                new ResPack( // 15
                        new ResChunk(ResType.WOOD, 30000)
                ),
                new ResPack( // 16
                        new ResChunk(ResType.WOOD, 34000)
                ),
                new ResPack( // 17
                        new ResChunk(ResType.WOOD, 38000)
                ),
                new ResPack( // 18
                        new ResChunk(ResType.WOOD, 42000)
                ),
                new ResPack( // 19
                        new ResChunk(ResType.WOOD, 46000)
                ),
                new ResPack( // 20
                        new ResChunk(ResType.WOOD, 50000)
                )
        });
    }
}
