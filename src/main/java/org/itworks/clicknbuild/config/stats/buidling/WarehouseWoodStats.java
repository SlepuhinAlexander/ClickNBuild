...
public final class WarehouseWoodStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setStore(new ResStatPack[]{
                new ResStatPack( // 1
                        new ResStat(ResType.WOOD, 1000)
                ),
                new ResStatPack( // 2
                        new ResStat(ResType.WOOD, 2000)
                ),
                new ResStatPack( // 3
                        new ResStat(ResType.WOOD, 3000)
                ),
                new ResStatPack( // 4
                        new ResStat(ResType.WOOD, 4000)
                ),
                new ResStatPack( // 5
                        new ResStat(ResType.WOOD, 5000)
                ),
                new ResStatPack( // 6
                        new ResStat(ResType.WOOD, 7000)
                ),
                new ResStatPack( // 7
                        new ResStat(ResType.WOOD, 9000)
                ),
                new ResStatPack( // 8
                        new ResStat(ResType.WOOD, 11000)
                ),
                new ResStatPack( // 9
                        new ResStat(ResType.WOOD, 13000)
                ),
                new ResStatPack( // 10
                        new ResStat(ResType.WOOD, 15000)
                ),
                new ResStatPack( // 11
                        new ResStat(ResType.WOOD, 18000)
                ),
                new ResStatPack( // 12
                        new ResStat(ResType.WOOD, 21000)
                ),
                new ResStatPack( // 13
                        new ResStat(ResType.WOOD, 24000)
                ),
                new ResStatPack( // 14
                        new ResStat(ResType.WOOD, 27000)
                ),
                new ResStatPack( // 15
                        new ResStat(ResType.WOOD, 30000)
                ),
                new ResStatPack( // 16
                        new ResStat(ResType.WOOD, 34000)
                ),
                new ResStatPack( // 17
                        new ResStat(ResType.WOOD, 38000)
                ),
                new ResStatPack( // 18
                        new ResStat(ResType.WOOD, 42000)
                ),
                new ResStatPack( // 19
                        new ResStat(ResType.WOOD, 46000)
                ),
                new ResStatPack( // 20
                        new ResStat(ResType.WOOD, 50000)
                )
        });
    }
}
