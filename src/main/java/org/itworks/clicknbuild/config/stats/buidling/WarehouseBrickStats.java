...
public final class WarehouseBrickStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setStore(new ResPack[]{
                ...
                new ResPack( // 3
                        new ResChunk(ResType.BRICK, 9000)
                ),
                new ResPack( // 4
                        new ResChunk(ResType.BRICK, 12000)
                ),
                new ResPack( // 5
                        new ResChunk(ResType.BRICK, 15000)
                ),
                new ResPack( // 6
                        new ResChunk(ResType.BRICK, 21000)
                ),
                new ResPack( // 7
                        new ResChunk(ResType.BRICK, 27000)
                ),
                new ResPack( // 8
                        new ResChunk(ResType.BRICK, 33000)
                ),
                new ResPack( // 9
                        new ResChunk(ResType.BRICK, 39000)
                ),
                new ResPack( // 10
                        new ResChunk(ResType.BRICK, 45000)
                ),
                new ResPack( // 11
                        new ResChunk(ResType.BRICK, 54000)
                ),
                new ResPack( // 12
                        new ResChunk(ResType.BRICK, 63000)
                ),
                new ResPack( // 13
                        new ResChunk(ResType.BRICK, 72000)
                ),
                new ResPack( // 14
                        new ResChunk(ResType.BRICK, 81000)
                ),
                new ResPack( // 15
                        new ResChunk(ResType.BRICK, 90000)
                ),
                new ResPack( // 16
                        new ResChunk(ResType.BRICK, 102000)
                ),
                new ResPack( // 17
                        new ResChunk(ResType.BRICK, 114000)
                ),
                new ResPack( // 18
                        new ResChunk(ResType.BRICK, 126000)
                ),
                new ResPack( // 19
                        new ResChunk(ResType.BRICK, 138000)
                ),
                new ResPack( // 20
                        new ResChunk(ResType.BRICK, 150000)
                )
        });
    }
}
