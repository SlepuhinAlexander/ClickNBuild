...
public final class WarehouseBrickStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setStore(new ResStatPack[]{
                ...
                new ResStatPack( // 3
                        new ResStat(ResType.BRICK, 9000)
                ),
                new ResStatPack( // 4
                        new ResStat(ResType.BRICK, 12000)
                ),
                new ResStatPack( // 5
                        new ResStat(ResType.BRICK, 15000)
                ),
                new ResStatPack( // 6
                        new ResStat(ResType.BRICK, 21000)
                ),
                new ResStatPack( // 7
                        new ResStat(ResType.BRICK, 27000)
                ),
                new ResStatPack( // 8
                        new ResStat(ResType.BRICK, 33000)
                ),
                new ResStatPack( // 9
                        new ResStat(ResType.BRICK, 39000)
                ),
                new ResStatPack( // 10
                        new ResStat(ResType.BRICK, 45000)
                ),
                new ResStatPack( // 11
                        new ResStat(ResType.BRICK, 54000)
                ),
                new ResStatPack( // 12
                        new ResStat(ResType.BRICK, 63000)
                ),
                new ResStatPack( // 13
                        new ResStat(ResType.BRICK, 72000)
                ),
                new ResStatPack( // 14
                        new ResStat(ResType.BRICK, 81000)
                ),
                new ResStatPack( // 15
                        new ResStat(ResType.BRICK, 90000)
                ),
                new ResStatPack( // 16
                        new ResStat(ResType.BRICK, 102000)
                ),
                new ResStatPack( // 17
                        new ResStat(ResType.BRICK, 114000)
                ),
                new ResStatPack( // 18
                        new ResStat(ResType.BRICK, 126000)
                ),
                new ResStatPack( // 19
                        new ResStat(ResType.BRICK, 138000)
                ),
                new ResStatPack( // 20
                        new ResStat(ResType.BRICK, 150000)
                )
        });
    }
}
