...
public final class WarehouseConcreteStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setStore(new ResPack[]{
                ...
                new ResPack( // 2
                        new ResChunk(ResType.CONCRETE, 8000)
                ),
                new ResPack( // 3
                        new ResChunk(ResType.CONCRETE, 12000)
                ),
                new ResPack( // 4
                        new ResChunk(ResType.CONCRETE, 16000)
                ),
                new ResPack( // 5
                        new ResChunk(ResType.CONCRETE, 20000)
                ),
                new ResPack( // 6
                        new ResChunk(ResType.CONCRETE, 28000)
                ),
                new ResPack( // 7
                        new ResChunk(ResType.CONCRETE, 36000)
                ),
                new ResPack( // 8
                        new ResChunk(ResType.CONCRETE, 44000)
                ),
                new ResPack( // 9
                        new ResChunk(ResType.CONCRETE, 52000)
                ),
                new ResPack( // 10
                        new ResChunk(ResType.CONCRETE, 60000)
                ),
                new ResPack( // 11
                        new ResChunk(ResType.CONCRETE, 72000)
                ),
                new ResPack( // 12
                        new ResChunk(ResType.CONCRETE, 84000)
                ),
                new ResPack( // 13
                        new ResChunk(ResType.CONCRETE, 96000)
                ),
                new ResPack( // 14
                        new ResChunk(ResType.CONCRETE, 108000)
                ),
                new ResPack( // 15
                        new ResChunk(ResType.CONCRETE, 120000)
                ),
                new ResPack( // 16
                        new ResChunk(ResType.CONCRETE, 136000)
                ),
                new ResPack( // 17
                        new ResChunk(ResType.CONCRETE, 152000)
                ),
                new ResPack( // 18
                        new ResChunk(ResType.CONCRETE, 168000)
                ),
                new ResPack( // 19
                        new ResChunk(ResType.CONCRETE, 184000)
                ),
                new ResPack( // 20
                        new ResChunk(ResType.CONCRETE, 200000)
                )
        });
    }
}
