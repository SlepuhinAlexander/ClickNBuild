...
public final class WarehouseConcreteStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setStore(new ResourcePack[]{
                ...
                new ResourcePack( // 2
                        new ResourceChunk(ResType.CONCRETE, 8000)
                ),
                new ResourcePack( // 3
                        new ResourceChunk(ResType.CONCRETE, 12000)
                ),
                new ResourcePack( // 4
                        new ResourceChunk(ResType.CONCRETE, 16000)
                ),
                new ResourcePack( // 5
                        new ResourceChunk(ResType.CONCRETE, 20000)
                ),
                new ResourcePack( // 6
                        new ResourceChunk(ResType.CONCRETE, 28000)
                ),
                new ResourcePack( // 7
                        new ResourceChunk(ResType.CONCRETE, 36000)
                ),
                new ResourcePack( // 8
                        new ResourceChunk(ResType.CONCRETE, 44000)
                ),
                new ResourcePack( // 9
                        new ResourceChunk(ResType.CONCRETE, 52000)
                ),
                new ResourcePack( // 10
                        new ResourceChunk(ResType.CONCRETE, 60000)
                ),
                new ResourcePack( // 11
                        new ResourceChunk(ResType.CONCRETE, 72000)
                ),
                new ResourcePack( // 12
                        new ResourceChunk(ResType.CONCRETE, 84000)
                ),
                new ResourcePack( // 13
                        new ResourceChunk(ResType.CONCRETE, 96000)
                ),
                new ResourcePack( // 14
                        new ResourceChunk(ResType.CONCRETE, 108000)
                ),
                new ResourcePack( // 15
                        new ResourceChunk(ResType.CONCRETE, 120000)
                ),
                new ResourcePack( // 16
                        new ResourceChunk(ResType.CONCRETE, 136000)
                ),
                new ResourcePack( // 17
                        new ResourceChunk(ResType.CONCRETE, 152000)
                ),
                new ResourcePack( // 18
                        new ResourceChunk(ResType.CONCRETE, 168000)
                ),
                new ResourcePack( // 19
                        new ResourceChunk(ResType.CONCRETE, 184000)
                ),
                new ResourcePack( // 20
                        new ResourceChunk(ResType.CONCRETE, 200000)
                )
        });
    }
}
