...
public final class WarehouseConcreteStats extends BuildingStats {
    private static volatile WarehouseConcreteStats inst;

    private WarehouseConcreteStats() {
    }

    public static WarehouseConcreteStats inst() {
        WarehouseConcreteStats local = inst;
        if (local == null) {
            synchronized (WarehouseConcreteStats.class) {
                local = inst;
                if (local == null) {
                    inst = local = new WarehouseConcreteStats();
                    local.initArrays();
                    local.initValues();
                }
            }
    ...
    protected void initValues() {
        ...
        setStore(new ResStatPack[]{
                ...
                new ResStatPack( // 2
                        new ResStat(ResType.CONCRETE, 8000)
                ),
                new ResStatPack( // 3
                        new ResStat(ResType.CONCRETE, 12000)
                ),
                new ResStatPack( // 4
                        new ResStat(ResType.CONCRETE, 16000)
                ),
                new ResStatPack( // 5
                        new ResStat(ResType.CONCRETE, 20000)
                ),
                new ResStatPack( // 6
                        new ResStat(ResType.CONCRETE, 28000)
                ),
                new ResStatPack( // 7
                        new ResStat(ResType.CONCRETE, 36000)
                ),
                new ResStatPack( // 8
                        new ResStat(ResType.CONCRETE, 44000)
                ),
                new ResStatPack( // 9
                        new ResStat(ResType.CONCRETE, 52000)
                ),
                new ResStatPack( // 10
                        new ResStat(ResType.CONCRETE, 60000)
                ),
                new ResStatPack( // 11
                        new ResStat(ResType.CONCRETE, 72000)
                ),
                new ResStatPack( // 12
                        new ResStat(ResType.CONCRETE, 84000)
                ),
                new ResStatPack( // 13
                        new ResStat(ResType.CONCRETE, 96000)
                ),
                new ResStatPack( // 14
                        new ResStat(ResType.CONCRETE, 108000)
                ),
                new ResStatPack( // 15
                        new ResStat(ResType.CONCRETE, 120000)
                ),
                new ResStatPack( // 16
                        new ResStat(ResType.CONCRETE, 136000)
                ),
                new ResStatPack( // 17
                        new ResStat(ResType.CONCRETE, 152000)
                ),
                new ResStatPack( // 18
                        new ResStat(ResType.CONCRETE, 168000)
                ),
                new ResStatPack( // 19
                        new ResStat(ResType.CONCRETE, 184000)
                ),
                new ResStatPack( // 20
                        new ResStat(ResType.CONCRETE, 200000)
                )
        });
    }
}
