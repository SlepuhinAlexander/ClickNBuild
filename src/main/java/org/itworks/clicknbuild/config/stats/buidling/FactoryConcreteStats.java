...
public final class FactoryConcreteStats extends BuildingStats {
    private static volatile FactoryConcreteStats inst;

    private FactoryConcreteStats() {
    }

    public static FactoryConcreteStats inst() {
        FactoryConcreteStats local = inst;
        if (local == null) {
            synchronized (FactoryConcreteStats.class) {
                local = inst;
                if (local == null) {
                    inst = local = new FactoryConcreteStats();
                    local.initArrays();
                    local.initValues();
                }
            }
    ...
    protected void initValues() {
        ...
        setProduction(new ResourcePack[]{
                new ResourcePack( // 1
                        new ResourceChunk(ResType.CONCRETE, 80)
                ),
                new ResourcePack( // 2
                        new ResourceChunk(ResType.CONCRETE, 160)
                ),
                new ResourcePack( // 3
                        new ResourceChunk(ResType.CONCRETE, 240)
                ),
                new ResourcePack( // 4
                        new ResourceChunk(ResType.CONCRETE, 320)
                ),
                new ResourcePack( // 5
                        new ResourceChunk(ResType.CONCRETE, 400)
                ),
                new ResourcePack( // 6
                        new ResourceChunk(ResType.CONCRETE, 560)
                ),
                new ResourcePack( // 7
                        new ResourceChunk(ResType.CONCRETE, 720)
                ),
                new ResourcePack( // 8
                        new ResourceChunk(ResType.CONCRETE, 880)
                ),
                new ResourcePack( // 9
                        new ResourceChunk(ResType.CONCRETE, 1040)
                ),
                new ResourcePack( // 10
                        new ResourceChunk(ResType.CONCRETE, 1280)
                ),
                new ResourcePack( // 11
                        new ResourceChunk(ResType.CONCRETE, 1520)
                ),
                new ResourcePack( // 12
                        new ResourceChunk(ResType.CONCRETE, 1760)
                ),
                new ResourcePack( // 13
                        new ResourceChunk(ResType.CONCRETE, 2000)
                ),
                new ResourcePack( // 14
                        new ResourceChunk(ResType.CONCRETE, 2240)
                ),
                new ResourcePack( // 15
                        new ResourceChunk(ResType.CONCRETE, 2480)
                ),
                new ResourcePack( // 16
                        new ResourceChunk(ResType.CONCRETE, 2800)
                ),
                new ResourcePack( // 17
                        new ResourceChunk(ResType.CONCRETE, 3120)
                ),
                new ResourcePack( // 18
                        new ResourceChunk(ResType.CONCRETE, 3440)
                ),
                new ResourcePack( // 19
                        new ResourceChunk(ResType.CONCRETE, 3680)
                ),
                new ResourcePack( // 20
                        new ResourceChunk(ResType.CONCRETE, 4000)
                )
        });
        ...
        setJobReward(new ResourcePack[]{
                new ResourcePack( // 1
                        new ResourceChunk(ResType.CONCRETE, 40)
                ),
                new ResourcePack( // 2
                        new ResourceChunk(ResType.CONCRETE, 80)
                ),
                new ResourcePack( // 3
                        new ResourceChunk(ResType.CONCRETE, 120)
                ),
                new ResourcePack( // 4
                        new ResourceChunk(ResType.CONCRETE, 160)
                ),
                new ResourcePack( // 5
                        new ResourceChunk(ResType.CONCRETE, 200)
                ),
                new ResourcePack( // 6
                        new ResourceChunk(ResType.CONCRETE, 280)
                ),
                new ResourcePack( // 7
                        new ResourceChunk(ResType.CONCRETE, 360)
                ),
                new ResourcePack( // 8
                        new ResourceChunk(ResType.CONCRETE, 440)
                ),
                new ResourcePack( // 9
                        new ResourceChunk(ResType.CONCRETE, 520)
                ),
                new ResourcePack( // 10
                        new ResourceChunk(ResType.CONCRETE, 640)
                ),
                new ResourcePack( // 11
                        new ResourceChunk(ResType.CONCRETE, 760)
                ),
                new ResourcePack( // 12
                        new ResourceChunk(ResType.CONCRETE, 880)
                ),
                new ResourcePack( // 13
                        new ResourceChunk(ResType.CONCRETE, 1000)
                ),
                new ResourcePack( // 14
                        new ResourceChunk(ResType.CONCRETE, 1120)
                ),
                new ResourcePack( // 15
                        new ResourceChunk(ResType.CONCRETE, 1240)
                ),
                new ResourcePack( // 16
                        new ResourceChunk(ResType.CONCRETE, 1400)
                ),
                new ResourcePack( // 17
                        new ResourceChunk(ResType.CONCRETE, 1560)
                ),
                new ResourcePack( // 18
                        new ResourceChunk(ResType.CONCRETE, 1720)
                ),
                new ResourcePack( // 19
                        new ResourceChunk(ResType.CONCRETE, 1840)
                ),
                new ResourcePack( // 20
                        new ResourceChunk(ResType.CONCRETE, 2000)
                )
