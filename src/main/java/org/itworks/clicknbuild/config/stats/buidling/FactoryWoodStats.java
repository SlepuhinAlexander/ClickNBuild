...
public final class FactoryWoodStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setProduction(new ResPack[]{
                ...
                new ResPack( // 2
                        new ResChunk(ResType.WOOD, 40)
                ),
                new ResPack( // 3
                        new ResChunk(ResType.WOOD, 60)
                ),
                new ResPack( // 4
                        new ResChunk(ResType.WOOD, 80)
                ),
                new ResPack( // 5
                        new ResChunk(ResType.WOOD, 100)
                ),
                new ResPack( // 6
                        new ResChunk(ResType.WOOD, 140)
                ),
                new ResPack( // 7
                        new ResChunk(ResType.WOOD, 180)
                ),
                new ResPack( // 8
                        new ResChunk(ResType.WOOD, 220)
                ),
                new ResPack( // 9
                        new ResChunk(ResType.WOOD, 260)
                ),
                new ResPack( // 10
                        new ResChunk(ResType.WOOD, 320)
                ),
                new ResPack( // 11
                        new ResChunk(ResType.WOOD, 380)
                ),
                new ResPack( // 12
                        new ResChunk(ResType.WOOD, 440)
                ),
                new ResPack( // 13
                        new ResChunk(ResType.WOOD, 500)
                ),
                new ResPack( // 14
                        new ResChunk(ResType.WOOD, 560)
                ),
                new ResPack( // 15
                        new ResChunk(ResType.WOOD, 620)
                ),
                new ResPack( // 16
                        new ResChunk(ResType.WOOD, 700)
                ),
                new ResPack( // 17
                        new ResChunk(ResType.WOOD, 780)
                ),
                new ResPack( // 18
                        new ResChunk(ResType.WOOD, 860)
                ),
                new ResPack( // 19
                        new ResChunk(ResType.WOOD, 920)
                ),
                new ResPack( // 20
                        new ResChunk(ResType.WOOD, 1000)
                )
        });
        ...
        setJobReward(new ResPack[]{
                ...
                new ResPack( // 5
                        new ResChunk(ResType.WOOD, 50)
                ),
                new ResPack( // 6
                        new ResChunk(ResType.WOOD, 70)
                ),
                new ResPack( // 7
                        new ResChunk(ResType.WOOD, 90)
                ),
                new ResPack( // 8
                        new ResChunk(ResType.WOOD, 110)
                ),
                new ResPack( // 9
                        new ResChunk(ResType.WOOD, 130)
                ),
                new ResPack( // 10
                        new ResChunk(ResType.WOOD, 160)
                ),
                new ResPack( // 11
                        new ResChunk(ResType.WOOD, 190)
                ),
                new ResPack( // 12
                        new ResChunk(ResType.WOOD, 220)
                ),
                new ResPack( // 13
                        new ResChunk(ResType.WOOD, 250)
                ),
                new ResPack( // 14
                        new ResChunk(ResType.WOOD, 280)
                ),
                new ResPack( // 15
                        new ResChunk(ResType.WOOD, 310)
                ),
                new ResPack( // 16
                        new ResChunk(ResType.WOOD, 350)
                ),
                new ResPack( // 17
                        new ResChunk(ResType.WOOD, 390)
                ),
                new ResPack( // 18
                        new ResChunk(ResType.WOOD, 430)
                ),
                new ResPack( // 19
                        new ResChunk(ResType.WOOD, 460)
                ),
                new ResPack( // 20
                        new ResChunk(ResType.WOOD, 500)
                )
