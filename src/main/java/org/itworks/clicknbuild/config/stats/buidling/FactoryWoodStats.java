...
public final class FactoryWoodStats extends BuildingStats {
    ...
    protected void initValues() {
        ...
        setProduction(new ResStatPack[]{
                ...
                new ResStatPack( // 2
                        new ResStat(ResType.WOOD, 40)
                ),
                new ResStatPack( // 3
                        new ResStat(ResType.WOOD, 60)
                ),
                new ResStatPack( // 4
                        new ResStat(ResType.WOOD, 80)
                ),
                new ResStatPack( // 5
                        new ResStat(ResType.WOOD, 100)
                ),
                new ResStatPack( // 6
                        new ResStat(ResType.WOOD, 140)
                ),
                new ResStatPack( // 7
                        new ResStat(ResType.WOOD, 180)
                ),
                new ResStatPack( // 8
                        new ResStat(ResType.WOOD, 220)
                ),
                new ResStatPack( // 9
                        new ResStat(ResType.WOOD, 260)
                ),
                new ResStatPack( // 10
                        new ResStat(ResType.WOOD, 320)
                ),
                new ResStatPack( // 11
                        new ResStat(ResType.WOOD, 380)
                ),
                new ResStatPack( // 12
                        new ResStat(ResType.WOOD, 440)
                ),
                new ResStatPack( // 13
                        new ResStat(ResType.WOOD, 500)
                ),
                new ResStatPack( // 14
                        new ResStat(ResType.WOOD, 560)
                ),
                new ResStatPack( // 15
                        new ResStat(ResType.WOOD, 620)
                ),
                new ResStatPack( // 16
                        new ResStat(ResType.WOOD, 700)
                ),
                new ResStatPack( // 17
                        new ResStat(ResType.WOOD, 780)
                ),
                new ResStatPack( // 18
                        new ResStat(ResType.WOOD, 860)
                ),
                new ResStatPack( // 19
                        new ResStat(ResType.WOOD, 920)
                ),
                new ResStatPack( // 20
        ...
        setJobReward(new ResStatPack[]{
                ...
                new ResStatPack( // 5
                        new ResStat(ResType.WOOD, 50)
                ),
                new ResStatPack( // 6
                        new ResStat(ResType.WOOD, 70)
                ),
                new ResStatPack( // 7
                        new ResStat(ResType.WOOD, 90)
                ),
                new ResStatPack( // 8
                        new ResStat(ResType.WOOD, 110)
                ),
                new ResStatPack( // 9
                        new ResStat(ResType.WOOD, 130)
                ),
                new ResStatPack( // 10
                        new ResStat(ResType.WOOD, 160)
                ),
                new ResStatPack( // 11
                        new ResStat(ResType.WOOD, 190)
                ),
                new ResStatPack( // 12
                        new ResStat(ResType.WOOD, 220)
                ),
                new ResStatPack( // 13
                        new ResStat(ResType.WOOD, 250)
                ),
                new ResStatPack( // 14
                        new ResStat(ResType.WOOD, 280)
                ),
                new ResStatPack( // 15
                        new ResStat(ResType.WOOD, 310)
                ),
                new ResStatPack( // 16
                        new ResStat(ResType.WOOD, 350)
                ),
                new ResStatPack( // 17
                        new ResStat(ResType.WOOD, 390)
                ),
                new ResStatPack( // 18
                        new ResStat(ResType.WOOD, 430)
                ),
                new ResStatPack( // 19
                        new ResStat(ResType.WOOD, 460)
                ),
                new ResStatPack( // 20
                        new ResStat(ResType.WOOD, 500)
                )
